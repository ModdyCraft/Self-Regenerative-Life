...
package net.moddycraft.selfregenerativelife.command;

import net.moddycraft.selfregenerativelife.procedures.SelfRegenerativeLifCommandCommandExecutedProcedure;
...
public class SelfRegenerativeLifCommandCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("Recover_Life")
				...
				.executes(SelfRegenerativeLifCommandCommand::execute));
	}
	...
	private static int execute(CommandContext<CommandSourceStack> ctx) {
		...
		SelfRegenerativeLifCommandCommandExecutedProcedure.execute(world, cmdparams);
		return 0;
	}
}
