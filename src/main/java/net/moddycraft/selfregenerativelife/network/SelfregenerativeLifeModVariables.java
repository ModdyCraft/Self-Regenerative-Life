package net.moddycraft.selfregenerativelife.network;

import net.moddycraft.selfregenerativelife.SelfregenerativeLifeMod;
...
public class SelfregenerativeLifeModVariables {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		SelfregenerativeLifeMod.addNetworkMessage(SavedDataSyncMessage.class, SavedDataSyncMessage::buffer, SavedDataSyncMessage::new,
	...
	public static class EventBusVariableHandlers {
		...
		public static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
			if (!event.getPlayer().level.isClientSide()) {
				...
				if (mapdata != null)
					SelfregenerativeLifeMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayer) event.getPlayer()),
	...
	public static class WorldVariables extends SavedData {
		public static final String DATA_NAME = "selfregenerative_life_worldvars";
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level level && !level.isClientSide())
				SelfregenerativeLifeMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(level::dimension), new SavedDataSyncMessage(1, this));
		}
	...
	public static class MapVariables extends SavedData {
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level && !world.isClientSide())
				SelfregenerativeLifeMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new SavedDataSyncMessage(0, this));
		}
